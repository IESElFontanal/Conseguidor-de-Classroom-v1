...
{
    public partial class FrmTarea2 : System.Windows.Forms.Form
    {
        ...
        private static FrmTarea2 frmTarea2 = null;
        ...
        public FrmTarea2(string idcurso, string idtarea, string titulo_tarea = null)
        {
            InitializeComponent();
            frmTarea2 = this;
            _idcurso = idcurso;
                ...
                if (Int32.Parse(fila.Cells["ClnNAdjuntosEnvío"].Value.ToString()) > 0)
                {
                    ...
                    if (envío.AssignmentSubmission != null)
                    {
                        if (envío.AssignmentSubmission.Attachments != null && envío.AssignmentSubmission.Attachments.Count > 0)
                        {
                            ...
                            var todasTareas = new List<Task> { }; //prueba
                    ...
                    case Google.Apis.Download.DownloadStatus.Completed:
                        {
                            ...
                            //DtgF.Rows.Add(nombre_alumno, saveTo, "OK");
                    ...
                    case Google.Apis.Download.DownloadStatus.Failed:
                        {
                            ...
                            string nombre_alumno = DtgO.Rows[idrow].Cells["ClnApellidosAlumno"].Value.ToString() + ", " + DtgO.Rows[idrow].Cells["ClnNombreAlumno"].Value.ToString();
                            //DtgF.Rows.Add(nombre_alumno, saveTo, "Error");
                            respuesta = 0;
                            break;
                        }
                }
